...
public class TimeTablePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager = (ViewPager) findViewById(R.id.timeTableViewPagerView);
        setupViewPager(viewPager);
        tabLayout = (TabLayout) findViewById(R.id.timeTableSlidingTabs);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               startActivity(new Intent(TimeTablePage.this,AddCourseToTimeTable.class));
            }
        });
    }
