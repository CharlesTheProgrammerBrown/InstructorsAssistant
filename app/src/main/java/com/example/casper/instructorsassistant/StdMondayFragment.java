...
public class StdMondayFragment extends Fragment {
    private RecyclerView recyclerView;
    private TimeTableListAdapter adapter;
    DatabaseReference mRef;
    FirebaseUser user;

    public StdMondayFragment() {
    }
    ...
    public void onStart() {
        ...
        if(adapter == null){
            adapter = new TimeTableListAdapter(new ArrayList<TimeTableInfo>());
            recyclerView.setAdapter(adapter);
            mRef.child("coursematerials").child(AllcoursesFragment.stdCourseSelected).child("timetable").child("Monday").addChildEventListener(new ChildEventListener() {
                @Override
